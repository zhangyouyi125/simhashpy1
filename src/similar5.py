'''
Author: zyy
Date: 2022-11-18 09:26:04
LastEditTime: 2022-11-18 09:26:18
Description: 
'''
#!/usr/bin/env python
# -*-coding:utf8-*-
...
def similar_simhash(file_path_1, file_path_2, stopword_path, threshold, sim):
    ...
    # Tokenization & weight TF-IDF 
    doc_words_1 = jt.tokens_sp2(doc_data_1)
    doc_words_2 = jt.tokens_sp2(doc_data_2)

    print ('computing hash')
    # hash word2vec
    #sim = SimhashBuilder()
    fingerprint_1 = sim.vectorize_w2v(doc_words_1)
    fingerprint_2 = sim.vectorize_w2v(doc_words_2)
...
if __name__ == "__main__":
    ...
    # Tokenization & weight TFF-IDF
    doc_words_1 = jt.tokens_tfidf(doc_data_1)
    doc_words_2 = jt.tokens_tfidf(doc_data_2)
